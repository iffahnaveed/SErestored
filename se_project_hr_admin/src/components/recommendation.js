...
function RecommendationPage() {
  ...
  const fetchShortlistedApplicants = async () => {
    try {
      const response = await axios.get("http://localhost:5002/api/auth/shortlisted-applicants");
  ...
  const fetchApplicants = async () => {
    try {
      const response = await axios.get("http://localhost:5002/api/auth/applicants");
  ...
  const fetchHRData = async () => {
    try {
      const response = await axios.get("http://localhost:5002/api/auth/hrs");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:5002/api/auth/recommendations", {
        hr_id: hrId,
